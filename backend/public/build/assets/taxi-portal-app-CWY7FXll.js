import{c as n,d as r,r as t,a as d}from"./runtime-dom.esm-bundler-hmS5lQzQ.js";const o=r({name:"TaxiPortalApp",setup(){const e=t("rides"),a=d(()=>{switch(e.value){case"rides":return"Mijn ritten";case"profile":return"Mijn gegevens";case"invoices":return"Facturen"}}),i=t([{id:1024,from:"Schiphol",to:"Amsterdam",at:"2026-06-02 10:30",status:"Gepland",amount:"€ 52,00"},{id:1008,from:"Amsterdam",to:"Utrecht",at:"2026-05-30 18:10",status:"Voltooid",amount:"€ 84,50"}]),l=t({first_name:"Jan",last_name:"Jansen",email:"jan@voorbeeld.nl",phone:"0612345678"});return{tab:e,title:a,rides:i,profile:l}},template:`
    <div class="flex grow">
      <!-- Sidebar -->
      <aside
  ...
  `}),s=document.getElementById("taxi-portal-app");s&&n(o).mount(s);
