...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $this->ensureInvoiceMollieColumns();
    }
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('platform_payment_mandates');
        Schema::dropIfExists('platform_invoices');
        Schema::dropIfExists('company_billing_profiles');
        Schema::dropIfExists('platform_billing_packages');
        Schema::dropIfExists('platform_billing_settings');
    }

    private function ensureInvoiceMollieColumns(): void
    {
        if (! Schema::hasTable('invoices')) {
            return;
        }
