<aside class="booking-module-v2-map-col" data-booking-live-map-panel aria-label="Routekaart">
    <div class="booking-module-v2-map-inner">
        ...
        <div class="booking-module-v2-map-empty absolute inset-0 z-10 flex items-center justify-center p-4 pointer-events-none" data-booking-live-map-empty>
            <span class="booking-module-v2-map-empty-msg">Kies een ophaal- of bestemmingsadres om de kaart te vullen.</span>
        </div>
