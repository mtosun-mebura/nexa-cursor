<div class="nexataxi-pricing my-10 md:my-14" data-nexataxi-pricing>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 mb-6 lg:mb-8">
        ...
        <div class="rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 transition-colors shadow-lg transition-transform duration-200 hover:-translate-y-2">
            <div class="nexataxi-card-image-wrap aspect-[16/10] w-full relative bg-gray-200 dark:bg-slate-700">
                ...
                <img src="{{ $imgCar }}" alt="" class="nexataxi-card-image w-full h-full object-cover opacity-0 transition-opacity ease-out" style="transition-duration: {{ $image_fade_duration ?? 1200 }}ms;" loading="lazy" onload="this.closest('.nexataxi-card-image-wrap').classList.add('image-loaded')" onerror="this.closest('.nexataxi-card-image-wrap').classList.add('image-loaded')">
            </div>
        ...
        <div class="rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 transition-colors shadow-lg transition-transform duration-200 hover:-translate-y-2">
            <div class="nexataxi-card-image-wrap aspect-[16/10] w-full relative bg-gray-200 dark:bg-slate-700">
                ...
                <img src="{{ $imgVan }}" alt="" class="nexataxi-card-image w-full h-full object-cover opacity-0 transition-opacity ease-out" style="transition-duration: {{ $image_fade_duration ?? 1200 }}ms;" loading="lazy" onload="this.closest('.nexataxi-card-image-wrap').classList.add('image-loaded')" onerror="this.closest('.nexataxi-card-image-wrap').classList.add('image-loaded')">
            </div>
            <div class="p-5 md:p-6 text-gray-900 dark:text-gray-100">
...
<script>
(function() {
    var root = document.querySelector('.nexataxi-pricing');
    if (!root) return;
