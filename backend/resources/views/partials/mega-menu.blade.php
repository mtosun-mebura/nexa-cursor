                                ...
                                <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                    ...
                                    <div class="grid lg:grid-cols-2 lg:gap-5">
                                        <div class="flex flex-col gap-0.5">
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/public-profile/profiles/default"
                                                    tabindex="0">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/public-profile/profiles/creator"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/public-profile/profiles/company"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/public-profile/profiles/nft" tabindex="0">
                                                    <span class="kt-menu-icon">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/public-profile/profiles/blogger"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                                        ...
                                        <div>
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/account/home/settings-modal"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                                ...
                                <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                    ...
                                    <div class="grid lg:grid-cols-2 lg:gap-5">
                                        <div class="flex flex-col gap-0.5">
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/public-profile/projects/3-columns"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/public-profile/projects/2-columns"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link" href="/demo1/public-profile/works"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link" href="/demo1/account/members/teams"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link" href="/demo1/public-profile/network"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link" href="/demo1/account/activity"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/public-profile/campaigns/card"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                                        ...
                                        <div>
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/public-profile/campaigns/list"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link" href="/demo1/public-profile/empty"
                                                    tabindex="0">
                                                    <span class="kt-menu-icon">
                    ...
                    <div class="kt-menu-dropdown w-full flex-col gap-0 lg:max-w-[1240px] lg:flex-row">
                        <div
                            ...
                            <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border border border-transparent"
                                        href="/demo1/account/notifications">
                                        <span class="kt-menu-icon">
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border border border-transparent"
                                        href="/demo1/account/invite-a-friend">
                                        <span class="kt-menu-icon">
                        ...
                        <div class="grow pb-2 pt-4 lg:p-7.5 lg:pb-5">
                            <div class="grid gap-5 lg:grid-cols-5">
                                <div class="flex flex-col">
                                    ...
                                    <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/security/get-started"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Get Started
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/home/user-profile"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    User Profile
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/account/billing/enterprise"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Enterprise
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/home/settings-plain"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Plain
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/home/settings-modal"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Modal
                                                </span>
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/billing/basic"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Basic Billing
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/billing/enterprise"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Enterprise
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/billing/plans"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Plans
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/billing/history"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Billing History
                                                </span>
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/account/security/get-started" tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Get Started
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/security/overview"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Security Overview
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/account/security/allowed-ip-addresses"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    IP Addresses
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/account/security/privacy-settings"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Privacy Settings
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/account/security/device-management"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Device Management
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/account/security/backup-and-recovery"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Backup & Recovery
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/account/security/current-sessions"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Current Sessions
                                                </span>
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/members/team-info"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Team Info
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/members/roles"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Roles
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/account/members/permissions-toggle"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/account/members/permissions-check"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Persmissions - Check
                                                </span>
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/integrations"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Integrations
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/notifications"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Notifications
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/api-keys"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    API Keys
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/appearance"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Appearance
                                                </span>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/account/invite-a-friend"
                                                tabindex="0">
                                                <span class="kt-menu-title grow-0">
                                                    Invite a Friend
                                                </span>
                        ...
                        <div class="flex flex-col lg:flex-row">
                            <div
                                ...
                                <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                    <div class="kt-menu-item">
                                        <a class="kt-menu-link kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border border border-transparent"
                                            href="/demo1/account/security/get-started">
                                            <span class="kt-menu-icon">
                                ...
                                <div class="grid gap-5 lg:grid-cols-2">
                                    <div class="flex flex-col gap-5">
                                        ...
                                        <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/network/user-cards/mini-cards"
                                                    tabindex="0">
                                                    <span class="kt-menu-title grow-0">
                                                        Mini Cards
                                                    </span>
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/network/user-table/team-crew"
                                                    tabindex="0">
                                                    <span class="kt-menu-title grow-0">
                                                        Team Crew
                                                    </span>
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link" href="/demo1/network/user-cards/nft"
                                                    tabindex="0">
                                                    <span class="kt-menu-title grow-0">
                                                        Authors
                                                    </span>
                                    ...
                                    <div class="flex flex-col gap-5">
                                        ...
                                        <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/network/user-table/app-roster"
                                                    tabindex="0">
                                                    <span class="kt-menu-title grow-0">
                                                        App Roster
                                                    </span>
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/network/user-table/market-authors"
                                                    tabindex="0">
                                                    <span class="kt-menu-title grow-0">
                                                        Market Authors
                                                    </span>
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/network/user-table/saas-users"
                                                    tabindex="0">
                                                    <span class="kt-menu-title grow-0">
                                                        SaaS Users
                                                    </span>
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/network/user-table/store-clients"
                                                    tabindex="0">
                                                    <span class="kt-menu-title grow-0">
                                                        Store Clients
                                                    </span>
                            ...
                            <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                ...
                                <div class="grid lg:grid-cols-2 lg:gap-5">
                                    <div class="flex flex-col gap-0.5">
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/store-client/search-results-grid"
                                                tabindex="0">
                                                <span class="kt-menu-icon">
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/store-client/search-results-list"
                                                tabindex="0">
                                                <span class="kt-menu-icon">
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/store-client/shopping-cart"
                                                tabindex="0">
                                                <span class="kt-menu-icon">
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/store-client/wishlist"
                                                tabindex="0">
                                                <span class="kt-menu-icon">
                                                    <i class="ki-filled ki-heart">
                                                    </i>
                                    ...
                                    <div>
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/store-client/checkout/order-summary"
                                                tabindex="0">
                                                <span class="kt-menu-icon">
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/store-client/checkout/shipping-info"
                                                tabindex="0">
                                                <span class="kt-menu-icon">
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/store-client/checkout/payment-method"
                                                tabindex="0">
                                                <span class="kt-menu-icon">
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="/demo1/store-client/checkout/order-placed"
                                                tabindex="0">
                                                <span class="kt-menu-icon">
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/store-client/my-orders"
                                                tabindex="0">
                                                <span class="kt-menu-icon">
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="/demo1/store-client/order-receipt"
                                                tabindex="0">
                                                <span class="kt-menu-icon">
                                                    <i class="ki-filled ki-document">
                                                    </i>
                        ...
                        <div class="flex flex-col lg:flex-row">
                                ...
                                <div class="grid gap-5 lg:grid-cols-2">
                                    <div class="flex flex-col">
                                        ...
                                        <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                            ...
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/authentication/branded/sign-up"
                                                    tabindex="0">
                                                    <span class="kt-menu-title grow-0">
                                                        Sign Up
                                                    </span>
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link"
                                                    href="/demo1/authentication/branded/sign-in"
                                                    tabindex="0">
                                                    <span class="kt-menu-title grow-0">
                                                        Sign In
                                                    </span>
                            ...
                            <div
                                ...
                                <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                    <div class="kt-menu-item">
                                        <a class="kt-menu-link kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border border border-transparent"
                                            href="/demo1/authentication/welcome-message">
                                            <span class="kt-menu-icon">
                                    ...
                                    <div class="kt-menu-item">
                                        <a class="kt-menu-link kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border border border-transparent"
                                            href="/demo1/authentication/account-deactivated">
                                            <span class="kt-menu-icon">
                                    ...
                                    <div class="kt-menu-item">
                                        <a class="kt-menu-link kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border border border-transparent"
                                            href="/demo1/authentication/error-404">
                                            <span class="kt-menu-icon">
                                    ...
                                    <div class="kt-menu-item">
                                        <a class="kt-menu-link kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border border border-transparent"
                                            href="/demo1/authentication/error-500">
                                            <span class="kt-menu-icon">
