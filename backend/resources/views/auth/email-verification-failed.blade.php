...
<head>
    <base href="{{ url('/') }}">
    <title>Verificatie mislukt - NEXA Skillmatching</title>
    <meta charset="utf-8"/>
        ...
        <div class="kt-card max-w-[440px] w-full">
            <div class="kt-card-content p-10">
                <div class="flex justify-center py-10">
                    <img alt="Error" class="dark:hidden max-h-[130px]" src="{{ asset('assets/media/illustrations/30.svg') }}"/>
                    <img alt="Error" class="light:hidden max-h-[130px]" src="{{ asset('assets/media/illustrations/30-dark.svg') }}"/>
                </div>
                ...
                <div class="text-sm text-center text-secondary-foreground mb-7.5">
                    ...
                    <span class="text-xs text-muted-foreground">
                        Tip: Neem contact op met de beheerder om een nieuwe activatielink aan te vragen.
                    </span>
                </div>
