        ...
        <div class="col-12">
            <div class="material-card">
                <div class="card-header">
                    <h5 >
                        <i class="fas fa-calendar-alt"></i> Nieuw Interview
                    </h5>
                            ...
                            <div class="col-md-6">
                                <div class="material-form-group">
                                    ...
                                    <input type="number" class="material-form-control @error('duration') is-invalid @enderror" 
                                           id="duration" name="duration" value="{{ old('duration', 60) }}" min="15" max="480">
                                    @error('duration')
                                        <div class="material-invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="material-form-group">
                                    ...
                                    <input type="text" class="material-form-control @error('interviewer_name') is-invalid @enderror" 
                                           id="interviewer_name" name="interviewer_name" value="{{ old('interviewer_name') }}">
                            ...
                            <div class="col-md-6">
                                <div class="material-form-group">
                                    ...
                                    <input type="email" class="material-form-control @error('interviewer_email') is-invalid @enderror" 
                                           id="interviewer_email" name="interviewer_email" value="{{ old('interviewer_email') }}">
                            ...
                            <div class="col-md-12">
                                <div class="material-form-group">
                                    ...
                                    <textarea class="material-form-control @error('feedback') is-invalid @enderror" 
                                              id="feedback" name="feedback" rows="6">{{ old('feedback') }}</textarea>
                                    @error('feedback')
                                        <div class="material-invalid-feedback">{{ $message }}</div>
                                    @enderror
