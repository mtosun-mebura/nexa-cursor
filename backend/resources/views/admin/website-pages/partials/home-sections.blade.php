...
(function() {
    ...
    function getTextBgFieldsRow(el) {
        if (!el || !el.closest) return null;
        return el.closest('.carousel-slide-row') || el.closest('.hero-text-bg-fields');
    }
    function syncCarouselSlideBgOpacityDisplay(range) {
        ...
        if (previewEl) {
            var row = getTextBgFieldsRow(range);
    ...
    function handleHeroAdminColorControlEvent(e) {
        ...
        if (carouselBgPicker) {
            ...
            var carouselBgRow = getTextBgFieldsRow(carouselBgPicker);
        ...
        if (carouselBgHexInp && carouselBgHexInp.id) {
            ...
            var carouselBgHexRow = getTextBgFieldsRow(carouselBgHexInp);
