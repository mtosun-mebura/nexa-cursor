        ...
        <div class="flex flex-col items-stretch gap-5 lg:gap-7.5">
            ...
            <div id="candidates_cards">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-7.5">
                    @foreach($candidates as $match)
                        @if($match->candidate)
                            <div class="kt-card cursor-pointer candidate-card" data-candidate-id="{{ $match->candidate_id }}" onclick="window.location.href='{{ route('admin.matches.show', $match) }}'">
            ...
            <div class="hidden" id="candidates_list">
                <div class="flex flex-col gap-5 lg:gap-7.5">
                    @foreach($candidates as $match)
                        @if($match->candidate)
                            <div class="kt-card p-7.5 cursor-pointer candidate-card" data-candidate-id="{{ $match->candidate_id }}" onclick="window.location.href='{{ route('admin.matches.show', $match) }}'">
