...
<div class="kt-container-fixed">
    ...
    <form action="{{ route('admin.roles.store') }}" method="POST"  data-validate="true" novalidate>
        @csrf
                    ...
                    <div class="mb-5" style="background-color: rgba(59, 130, 246, 0.08); border: 1px solid rgba(59, 130, 246, 0.25); border-radius: 0.5rem; padding: 1.25rem 1.5rem; margin: 16px;">
                        <div class="flex items-start gap-3 mb-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <h4 class="text-base font-medium text-foreground dark:text-white mb-1">Snel Toepassen: Permissie Sets</h4>
