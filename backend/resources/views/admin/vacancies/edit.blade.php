        ...
        <div class="col-12">
            <div class="material-card">
                <div class="card-header">
                    ...
                    <div>
                        <a href="{{ route('admin.vacancies.show', $vacancy) }}" class="material-btn material-btn-info me-2">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.vacancies.update', $vacancy) }}" method="POST">
                        ...
                        <div class="material-form-actions">
                            <a href="{{ route('admin.vacancies.index') }}" class="material-btn material-btn-secondary">Annuleren</a>
