...
@section('title', 'Job Configuratie Type Bewerken')
    ...
    <div class="flex flex-col gap-5 pb-7.5">
        <div class="flex flex-wrap items-center justify-between gap-5">
            <h1 class="text-xl font-medium leading-none text-mono">
                Job Configuratie Type Bewerken
            </h1>
        </div>
        <div class="flex items-center">
            <a href="{{ route('admin.job-configuration-types.show', $jobConfigurationType) }}" class="kt-btn kt-btn-outline">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" 
                                       ...
                                       name="display_name" 
                                       value="{{ old('display_name', $jobConfigurationType->display_name) }}" 
                                       required 
                                       maxlength="100"
                        ...
                        <tr>
                            ...
                            <td class="min-w-48 w-full">
                                <input type="text" 
                                       ...
                                       name="name" 
                                       value="{{ old('name', $jobConfigurationType->name) }}" 
                                       required 
                                       maxlength="50"
                                       pattern="[a-z_]+"
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea class="kt-input pt-1 @error('description') border-destructive @enderror" 
                                          name="description" 
                                          rows="3" 
                                          placeholder="Beschrijving van dit type...">{{ old('description', $jobConfigurationType->description) }}</textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" 
                                       ...
                                       name="sort_order" 
                                       value="{{ old('sort_order', $jobConfigurationType->sort_order) }}" 
                                       min="0"
                                       step="1">
                            ...
                            <td>
                                <label class="kt-label flex items-center">
                                    <input type="checkbox" 
                                           ...
                                           name="is_active" 
                                           value="1" 
                                           {{ old('is_active', $jobConfigurationType->is_active) ? 'checked' : '' }}>
