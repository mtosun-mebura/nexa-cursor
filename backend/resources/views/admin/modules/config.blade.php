...
<div class="kt-container-fixed">
    @if(auth()->user()->hasRole('super-admin') && !($moduleConfigTenantScopedActive ?? false))
        <div class="tenant-scope-notice mb-5 flex gap-3 rounded-xl px-4 py-4 text-sm shadow-md" role="status">
            ...
            <div class="min-w-0 flex-1 leading-relaxed text-white">
                ...
                <p class="mt-1.5 mb-0 text-white">Kies links in de zijbalk een <strong class="font-semibold text-white">tenant (bedrijf)</strong> voordat u module-instellingen kunt opslaan. Zonder tenant ziet u de standaardwaarden.</p>
            </div>
        </div>
    @elseif($moduleConfigTenantCompany ?? null)
