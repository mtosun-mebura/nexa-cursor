            ...
            <div class="kt-menu flex grow flex-col gap-1" data-kt-menu="true" data-kt-menu-accordion-expand-all="false"
                ...
                <div class="kt-menu-item {{ request()->routeIs('admin.dashboard') || request()->routeIs('admin.tenant-setup-checklist') ? 'here show' : '' }}"
                    ...
                    <div class="kt-menu-accordion relative gap-1 ps-[10px] before:absolute before:bottom-0 before:start-[20px] before:top-0 before:border-s before:border-border">
                        ...
                        <div class="kt-menu-item {{ request()->routeIs('admin.tenant-setup-checklist') ? 'active' : '' }}">
                            <a class="kt-menu-link kt-menu-item-active:bg-accent/60 dark:menu-item-active:border-border kt-menu-item-active:rounded-lg hover:bg-accent/60 grow items-center gap-[14px] border border-transparent py-[8px] pe-[10px] ps-[10px] hover:rounded-lg"
                                href="{{ route('admin.tenant-setup-checklist') }}" tabindex="0">
                                <span class="kt-menu-bullet kt-menu-item-active:before:bg-primary kt-menu-item-hover:before:bg-primary relative -start-[3px] flex w-[6px] before:absolute before:top-0 before:size-[6px] before:-translate-y-1/2 before:rounded-full rtl:start-0 rtl:before:translate-x-1/2"></span>
                                <span class="kt-menu-title text-2sm kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-link-hover:!text-primary font-normal text-foreground">
                                    Tenant configureren
                                </span>
                    ...
                    @if($routeExists || $moduleMenuChildren !== [])
                        ...
                        <div class="kt-menu-item {{ $isActive ? 'here show' : '' }}" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
                            ...
                            <div class="kt-menu-accordion relative gap-1 ps-[10px] before:absolute before:bottom-0 before:start-[20px] before:top-0 before:border-s before:border-border">
                                @foreach($moduleMenuChildren as $childItem)
                                    @php
                                        $childActive = \App\Services\MenuService::childMenuItemIsActive($childItem, $moduleMenuChildren);
                                    @endphp
                ...
                <div class="kt-menu-item {{ request()->routeIs('admin.newsletters.*') ? 'here show' : '' }}"
                    ...
                    <div class="kt-menu-link flex grow cursor-pointer items-center gap-[10px] border border-transparent py-[6px] pe-[10px] ps-[10px]"
                        tabindex="0">
                        <span class="kt-menu-icon w-[20px] items-start text-muted-foreground">
                            <i class="ki-filled ki-speaker text-lg"></i>
                        </span>
                        <span class="kt-menu-title kt-menu-item-active:text-primary kt-menu-link-hover:!text-primary text-sm font-medium text-foreground">
                            Nieuwsbrieven
                        </span>
                ...
                @if(auth()->user()?->hasRole('super-admin'))
                <div class="kt-menu-item {{ request()->routeIs('admin.platform-billing.*') ? 'here show' : '' }}"
                     data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
                    <div class="kt-menu-link flex grow cursor-pointer items-center gap-[10px] border border-transparent py-[6px] pe-[10px] ps-[10px]" tabindex="0">
                        <span class="kt-menu-icon w-[20px] items-start text-muted-foreground">
                    ...
                    <div class="kt-menu-accordion relative gap-1 ps-[10px] before:absolute before:bottom-0 before:start-[20px] before:top-0 before:border-s before:border-border">
                        ...
                        <div class="kt-menu-item {{ request()->routeIs('admin.platform-billing.line-items.*') ? 'active' : '' }}">
                            <a class="kt-menu-link border border-transparent items-center grow kt-menu-item-active:bg-accent/60 hover:bg-accent/60 hover:rounded-lg gap-[14px] ps-[10px] pe-[10px] py-[8px] rounded-lg" href="{{ route('admin.platform-billing.line-items.index') }}">
                                <span class="kt-menu-bullet flex w-[6px] -start-[3px] relative before:absolute before:top-0 before:size-[6px] before:rounded-full before:-translate-y-1/2 kt-menu-item-active:before:bg-primary"></span>
                                <span class="kt-menu-title text-2sm font-normal text-foreground">Factuurregels</span>
                            </a>
                        </div>
                        <div class="kt-menu-item {{ request()->routeIs('admin.platform-billing.settings.*') ? 'active' : '' }}">
                            <a class="kt-menu-link border border-transparent items-center grow kt-menu-item-active:bg-accent/60 hover:bg-accent/60 hover:rounded-lg gap-[14px] ps-[10px] pe-[10px] py-[8px] rounded-lg" href="{{ route('admin.platform-billing.settings.edit') }}">
                                <span class="kt-menu-bullet flex w-[6px] -start-[3px] relative before:absolute before:top-0 before:size-[6px] before:rounded-full before:-translate-y-1/2 kt-menu-item-active:before:bg-primary"></span>
                                <span class="kt-menu-title text-2sm font-normal text-foreground">Facturatie-instellingen</span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="kt-menu-item {{ request()->routeIs('admin.settings.frontend.*') || $isWelcomeMenuActive || $isWebsitePagesMenuActive || $isWebsiteAiMenuActive || $isAiImagesMenuActive || request()->routeIs('admin.frontend-themes.*') || request()->routeIs('admin.frontend-components.*') || request()->routeIs('admin.playground.metronic-demo1') ? 'here show' : '' }}"
                    ...
                    <div
                        ...
                        <div class="kt-menu-item {{ $isWebsiteAiMenuActive ? 'active' : '' }}">
                            <a class="kt-menu-link kt-menu-item-active:bg-accent/60 dark:menu-item-active:border-border kt-menu-item-active:rounded-lg hover:bg-accent/60 grow items-center gap-[14px] border border-transparent py-[8px] pe-[10px] ps-[10px] hover:rounded-lg"
                                href="{{ route('admin.website-ai.create') }}" tabindex="0">
                                <span class="kt-menu-bullet kt-menu-item-active:before:bg-primary kt-menu-item-hover:before:bg-primary relative -start-[3px] flex w-[6px] before:absolute before:top-0 before:size-[6px] before:-translate-y-1/2 before:rounded-full rtl:start-0 rtl:before:translate-x-1/2"></span>
                                <span class="kt-menu-title text-2sm kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-link-hover:!text-primary font-normal text-foreground">
                                    Genereer website AI
                                </span>
