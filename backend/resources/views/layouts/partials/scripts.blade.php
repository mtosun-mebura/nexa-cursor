...
<script src="{{ asset('assets/js/search-input-clear.js') }}" defer></script>

<!-- KT-Select Placeholder Styling (for consistent dropdown styling) -->
<script src="{{ asset('assets/js/kt-select-placeholder-styling.js') }}" defer></script>

<!-- Backend Header Badges -->
<script src="{{ asset('js/backend-header-badges.js') }}" defer></script>

<!-- Notifications Drawer -->
<script src="{{ asset('js/notifications-drawer.js') }}" defer></script>
