...
<div class="kt-container-fixed">
    <div class="flex flex-wrap items-center justify-between gap-5 pb-7.5">
        ...
        <a href="{{ route('admin.skillmatching.vacancies.create') }}" class="kt-btn kt-btn-primary">
            ...
            <div class="kt-card-header py-5 flex-wrap gap-2">
                ...
                <div class="flex flex-col sm:flex-row flex-wrap gap-2 lg:gap-5 justify-center sm:justify-end items-center w-full">
                    ...
                    <div class="flex w-full sm:w-auto justify-center sm:justify-start">
                        <form method="GET" action="{{ route('admin.skillmatching.vacancies.index') }}" class="flex gap-2" id="search-form">
                            @if(request('status'))
...
/>
                    ...
                    <div class="flex flex-col sm:flex-row flex-wrap gap-2.5 items-center justify-center sm:justify-start w-full sm:w-auto">
                        <form method="GET" action="{{ route('admin.skillmatching.vacancies.index') }}" id="filters-form" class="flex flex-col sm:flex-row gap-2.5 w-full sm:w-auto items-center sm:items-stretch">
                            @if(request('search'))
                            ...
                            <a href="{{ route('admin.skillmatching.vacancies.index') }}"
            ...
            <div class="kt-card-content">
                @if($vacancies->count() > 0)
                    <div class="grid" data-admin-datatable="true" data-admin-datatable-page-size="10" id="vacancies_table" data-admin-datatable-label="vacatures">
                                        ...
                                        <tr class="vacancy-row" data-vacancy-id="{{ $vacancy->id }}">
                                            <td>
                                                <div class="flex flex-col">
                                                    <a class="text-sm font-medium text-mono hover:text-primary mb-px" href="{{ route('admin.skillmatching.vacancies.show', $vacancy) }}" data-vacancy-id="{{ $vacancy->id }}">
                                                        {{ $vacancy->title }}
                                                    </a>
                                                    @if($vacancy->location)
                                            ...
                                            <td class="text-foreground font-normal">
                                                <a class="text-sm hover:text-primary" href="{{ route('admin.skillmatching.matches.index', ['vacancy' => $vacancy->id]) }}" onclick="event.stopPropagation();">
                                                ...
                                                <div class="kt-menu flex justify-center" data-kt-menu="true">
                                                    <div class="kt-menu-item"
                                                        ...
                                                        <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                                            @can('view-vacancies')
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link" href="{{ route('admin.skillmatching.vacancies.show', $vacancy) }}">
                                                            ...
                                                            @can('edit-vacancies')
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link" href="{{ route('admin.skillmatching.vacancies.edit', $vacancy) }}">
                                                            ...
                                                            @if($vacancy->matches_count > 0)
                                                                ...
                                                                <div class="kt-menu-item">
                                                                    <a class="kt-menu-link" href="{{ route('admin.skillmatching.matches.candidates', $vacancy->id) }}">
                                                            ...
                                                            @can('delete-vacancies')
                                                                <div class="kt-menu-separator"></div>
                                                                <div class="kt-menu-item">
                                                                    <form action="{{ route('admin.skillmatching.vacancies.destroy', $vacancy) }}" method="POST" onsubmit="return confirm('Weet je zeker dat je deze vacature wilt verwijderen?')">
                                                                        @csrf
                                                                        @method('DELETE')
                        ...
                        <div class="kt-card-footer admin-datatable-footer text-secondary-foreground text-sm font-medium">
                            <div class="admin-datatable-footer__perpage flex items-center gap-2">
                                Toon
                                <select class="kt-select w-24" data-admin-datatable-size="true" data-kt-select="" name="perpage"></select>
                                per pagina
                            </div>
