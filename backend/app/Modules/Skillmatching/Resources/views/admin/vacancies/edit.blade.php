...
<div class="kt-container-fixed vacancy-edit" style="padding-top: 90px;">
    <div class="flex flex-col gap-5 pb-7.5">
        ...
        <div class="flex items-center">
            <a href="{{ route('admin.skillmatching.vacancies.show', $vacancy) }}" class="kt-btn kt-btn-outline">
    ...
    <form action="{{ route('admin.skillmatching.vacancies.update', $vacancy) }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-5 lg:gap-7.5" data-validate="true">
        @csrf
        @method('PUT')
        ...
        <div class="grid gap-5 lg:gap-7.5">
            ...
            <div class="flex items-center justify-end gap-2.5">
                <a href="{{ route('admin.skillmatching.vacancies.show', $vacancy) }}" class="kt-btn kt-btn-outline">Annuleren</a>
