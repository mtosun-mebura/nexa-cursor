...
<div class="kt-container-fixed vacancy-create">
    ...
    <form action="{{ route('admin.skillmatching.vacancies.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-5 lg:gap-7.5" data-validate="true">
        @csrf
        ...
        <div class="grid gap-5 lg:gap-7.5">
            ...
            <div class="flex items-center justify-end gap-2.5">
                <a href="{{ route('admin.skillmatching.vacancies.index') }}" class="kt-btn kt-btn-outline">Annuleren</a>
