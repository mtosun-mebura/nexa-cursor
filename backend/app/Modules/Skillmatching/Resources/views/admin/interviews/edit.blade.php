    ...
    <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
        <div class="flex flex-col justify-center gap-2">
            ...
            <div class="mt-3 flex gap-2">
                ...
                <a href="{{ route('admin.skillmatching.interviews.index') }}" class="kt-btn kt-btn-outline">
                    <i class="ki-filled ki-arrow-left me-2"></i>
        ...
        <div class="flex items-center gap-2.5">
            <a href="{{ route('admin.skillmatching.interviews.show', $interview) }}" class="kt-btn kt-btn-outline">
...
<div class="kt-container-fixed">
    <div class="flex flex-col items-stretch grow">
        <form action="{{ route('admin.skillmatching.interviews.update', $interview) }}" method="POST" class="flex flex-col gap-5 lg:gap-7.5" novalidate>
            @csrf
            @method('PUT')
