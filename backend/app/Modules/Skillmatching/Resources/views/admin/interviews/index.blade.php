            ...
            <div class="kt-card-header py-5 flex-wrap gap-2">
                ...
                <div class="flex flex-col sm:flex-row flex-wrap gap-2 lg:gap-5 justify-center sm:justify-end items-center w-full">
                    ...
                    <div class="flex w-full sm:w-auto justify-center sm:justify-start">
                        <form method="GET" action="{{ route('admin.skillmatching.interviews.index') }}" class="flex gap-2" id="search-form">
                            @if(request('status'))
...
/>
                    ...
                    <div class="flex flex-col sm:flex-row flex-wrap gap-2.5 items-center justify-center sm:justify-start w-full sm:w-auto">
                        <form method="GET" action="{{ route('admin.skillmatching.interviews.index') }}" id="filters-form" class="flex flex-col sm:flex-row gap-2.5 w-full sm:w-auto items-center sm:items-stretch">
                            @if(request('search'))
                        ...
                        <a href="{{ route('admin.skillmatching.interviews.index') }}" 
            ...
            <div class="kt-card-content">
                @if($interviews->count() > 0)
                    <div class="grid" data-admin-datatable="true" data-admin-datatable-page-size="10" id="interviews_table" data-admin-datatable-label="interviews">
                                                ...
                                                <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
                                                    ...
                                                    <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="{{ route('admin.skillmatching.interviews.show', $interview) }}">
                                                        ...
                                                        @can('edit-interviews')
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="{{ route('admin.skillmatching.interviews.edit', $interview) }}">
                                                                <span class="kt-menu-icon">
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <form action="{{ route('admin.skillmatching.interviews.destroy', $interview) }}" 
                                                                  method="POST" 
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var interviewsShowBaseUrl = '{{ route("admin.skillmatching.interviews.index") }}'.replace(/\/$/, '') + '/';
