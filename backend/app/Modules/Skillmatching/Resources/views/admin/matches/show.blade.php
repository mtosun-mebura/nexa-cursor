                                    ...
                                    @if($contactName || $contactEmail || $contactPhone || $contactPhoto)
                                        <div class="flex items-start gap-3">
                                            @if($contactPhoto)
                                                ...
                                                @else
                                                    <img src="{{ route('admin.skillmatching.vacancies.contact-photo', $match->vacancy) }}" alt="Contactpersoon avatar" class="w-12 h-12 rounded-full object-cover border-2 border-input shrink-0 mt-0.5">
                                                @endif
                                            @endif
...
<script>
    ...
    function refreshActivity() {
        fetch(`{{ route('admin.skillmatching.matches.show', $match) }}`, {
            method: 'GET',
            headers: {
