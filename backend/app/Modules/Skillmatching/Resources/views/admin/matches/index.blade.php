...
<div class="kt-container-fixed">
    <div class="flex flex-wrap items-center justify-between gap-5 pb-7.5">
        ...
        @can('create-matches')
        <a href="{{ route('admin.skillmatching.matches.create') }}" class="kt-btn kt-btn-primary">
            ...
            <div class="kt-card-header py-5 flex-wrap gap-2">
                ...
                <div class="flex flex-col sm:flex-row flex-wrap gap-2 lg:gap-5 justify-center sm:justify-end items-center w-full">
                    ...
                    <div class="flex w-full sm:w-auto justify-center sm:justify-start">
                        <form method="GET" action="{{ route('admin.skillmatching.matches.index') }}" class="flex gap-2" id="search-form">
                            @if(request('status'))
                    ...
                    <div class="flex flex-col sm:flex-row flex-wrap gap-2.5 items-center justify-center sm:justify-start w-full sm:w-auto">
                        <form method="GET" action="{{ route('admin.skillmatching.matches.index') }}" id="filters-form" class="flex flex-col sm:flex-row gap-2.5 w-full sm:w-auto items-center sm:items-stretch">
                            @if(request('search'))
                        ...
                        <a href="{{ route('admin.skillmatching.matches.index') }}" 
                                                ...
                                                <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
                                                    ...
                                                    <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="{{ route('admin.skillmatching.matches.show', $match) }}">
                                                        ...
                                                        @can('delete-matches')
                                                        <div class="kt-menu-item">
                                                            <form action="{{ route('admin.skillmatching.matches.destroy', $match) }}" 
                                                                  method="POST" 
