    ...
    <div class="kt-card">
        <div class="kt-card-header py-5 flex-wrap gap-2">
            ...
            <div class="flex flex-col sm:flex-row flex-wrap gap-2.5 w-full justify-center sm:justify-end items-center">
                <form method="GET" action="{{ route('admin.taxiroyaal.ride_requests.index') }}" id="ride-filters-form" class="flex flex-col sm:flex-row gap-2.5 w-full sm:w-auto">
                ...
                <a href="{{ route('admin.taxiroyaal.ride_requests.index') }}" class="kt-btn kt-btn-outline kt-btn-icon" title="Filters resetten">
        ...
        <div class="kt-card-table kt-scrollable-x-auto">
            <table class="kt-table kt-table-border-dashed align-middle text-sm">
                ...
                <tbody>
                    ...
                    <tr
                        @if($canViewRide)
                            data-row-href="{{ route('admin.taxiroyaal.ride_requests.show', $r) }}"
                                ...
                                <div class="kt-menu inline-flex justify-end" data-kt-menu="true">
                                    <div class="kt-menu-item"
                                        ...
                                        <div class="kt-menu-dropdown kt-menu-default w-[190px] min-w-[190px]" data-kt-menu-dismiss="true">
                                            @if($canViewRide)
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link" href="{{ route('admin.taxiroyaal.ride_requests.show', $r) }}">
                                            ...
                                            @if($canUpdateRide)
                                            <div class="kt-menu-item">
                                                <a class="kt-menu-link" href="{{ route('admin.taxiroyaal.ride_requests.edit', $r) }}">
                                                    <span class="kt-menu-icon">
        ...
        <div class="kt-card-footer justify-center md:justify-between flex-col md:flex-row gap-5 text-secondary-foreground text-sm font-medium pt-5">
            <div class="flex items-center gap-2 order-2 md:order-1">
                Toon
                <form method="GET" action="{{ route('admin.taxiroyaal.ride_requests.index') }}" class="inline" id="ride-perpage-form">
