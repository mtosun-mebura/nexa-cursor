...
class RideRequestController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('taxiroyaal::admin.ride_requests.index', compact('rideRequests', 'vehicles', 'statusLabels'));
    }
    ...
    public function create()
    {
        ...
        return view('taxiroyaal::admin.ride_requests.create', compact('vehicles', 'drivers', 'statusLabels'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.taxiroyaal.ride_requests.show', $ride)->with('success', 'Rit is aangemaakt.');
    }
    ...
    public function edit(RideRequest $ride_request)
    {
        ...
        return view('taxiroyaal::admin.ride_requests.edit', ['ride' => $ride_request, 'vehicles' => $vehicles, 'drivers' => $drivers, 'statusLabels' => $statusLabels]);
    }
    ...
    public function update(Request $request, RideRequest $ride_request)
    {
        ...
        return redirect()->route('admin.taxiroyaal.ride_requests.show', $ride_request)->with('success', 'Rit is bijgewerkt.');
    }
    ...
    public function destroy(RideRequest $ride_request)
    {
        ...
        $ride_request->delete();
        return redirect()->route('admin.taxiroyaal.ride_requests.index')->with('success', 'Rit is verwijderd.');
    }
    ...
    public function assign(Request $request, RideRequest $ride_request)
    {
        ...
        return redirect()->route('admin.taxiroyaal.ride_requests.show', $ride_request)->with('success', 'Voertuig en chauffeur toegewezen.');
    }
