        ...
        <div class="kt-card kt-card-grid w-full min-w-0">
            <div class="kt-card-header py-5 flex-wrap gap-2">
                ...
                <div class="flex flex-col sm:flex-row flex-wrap gap-2 lg:gap-5 justify-center sm:justify-end items-center w-full">
                    ...
                    <form method="GET" action="{{ route('admin.taxi.vehicles.index') }}" id="filters-form" class="flex flex-col sm:flex-row gap-2.5 w-full sm:w-auto">
                    ...
                    <a href="{{ route('admin.taxi.vehicles.index') }}" class="kt-btn kt-btn-outline kt-btn-icon" title="Filters resetten">
                ...
                <div class="kt-scrollable-x-auto">
                    <table class="kt-table table-auto kt-table-border">
                        ...
                        <tbody>
                            ...
                            <tr class="vehicle-row vehicle-row--clickable" data-vehicle-id="{{ $v->id }}" data-href="{{ route('admin.taxi.vehicles.show', $v) }}">
                                        ...
                                        <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
                                            ...
                                            <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                                ...
                                                <div class="kt-menu-item">
                                                    <a class="kt-menu-link" href="{{ route('admin.taxi.vehicles.show', $v) }}">
                                                ...
                                                <div class="kt-menu-item">
                                                    <a class="kt-menu-link" href="{{ route('admin.taxi.vehicles.edit', $v) }}">
                                                        <span class="kt-menu-icon">
                                                ...
                                                <div class="kt-menu-item">
                                                    <form action="{{ route('admin.taxi.vehicles.destroy', $v) }}" method="POST" style="display: inline;" onsubmit="return confirm('Weet je zeker dat je dit voertuig wilt verwijderen?');">
                                                        @csrf
                                                        @method('DELETE')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.vehicles-table-wrap .kt-menu, .vehicles-table-wrap .kt-menu-dropdown')) return;
