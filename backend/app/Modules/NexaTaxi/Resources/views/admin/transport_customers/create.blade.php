...
@section('title', 'Nieuwe contractklant')

@section('content')
<div class="kt-container-fixed min-w-0">
    <div class="pb-7.5">
        <h1 class="text-xl font-medium leading-none text-mono">Nieuwe contractklant</h1>
        <div class="pt-3">
    ...
    <form method="POST" action="{{ route('admin.taxi.transport_customers.store') }}">
        @csrf
                        ...
                        <table class="kt-table kt-table-border-dashed align-middle text-sm text-muted-foreground wizard-onboarding-form-table w-full">
                            <tr>
                                ...
                                <td class="min-w-48 w-full">
                                    <input type="text" name="name" value="{{ old('name') }}" class="kt-input w-full" required maxlength="200" placeholder="bijv. School A">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="email" name="contact_email" value="{{ old('contact_email') }}" class="kt-input w-full" maxlength="200">
                                </td>
                            </tr>
                            <tr>
                                <td class="text-secondary-foreground font-normal">Telefoonnummer</td>
                                <td>
                                    <input type="text" name="contact_phone" value="{{ old('contact_phone') }}" class="kt-input w-full" maxlength="50">
                                </td>
                            </tr>
                            <tr>
                                <td class="text-secondary-foreground font-normal">Debiteurnummer</td>
                                <td>
                                    <input type="text" name="debtor_number" value="{{ old('debtor_number') }}" class="kt-input w-full" maxlength="50">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label class="kt-label flex items-center gap-2 mb-0" for="active">
                                        <input type="checkbox" name="active" id="active" value="1" class="kt-switch kt-switch-sm shrink-0" @checked(old('active', true))>
                    ...
                    <div class="px-3 sm:px-5 pb-3 min-w-0">
                        <table class="kt-table kt-table-border-dashed align-middle text-sm text-muted-foreground wizard-onboarding-form-table w-full">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="billing_postal_code" value="{{ old('billing_postal_code') }}" class="kt-input w-full" maxlength="20">
                                </td>
                            </tr>
                            <tr>
                                <td class="text-secondary-foreground font-normal">Stad</td>
                                <td>
                                    <input type="text" name="billing_city" value="{{ old('billing_city') }}" class="kt-input w-full" maxlength="100">
                                </td>
                            </tr>
                            <tr>
                                <td class="text-secondary-foreground font-normal">Land</td>
                                <td>
                                    <input type="text" name="billing_country" value="{{ old('billing_country', 'Nederland') }}" class="kt-input w-full" maxlength="100">
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="kt-card w-full min-w-0">
                ...
                <div class="kt-card-content p-0">
                    <div class="px-3 sm:px-5 pt-3 pb-3 min-w-0">
                        <textarea name="notes" rows="4" class="kt-textarea w-full" placeholder="Interne notities...">{{ old('notes') }}</textarea>
                    </div>
                </div>
            </div>
        ...
        <div class="admin-form-actions flex flex-wrap items-center justify-end gap-2.5 mt-5 w-full min-w-0">
            <a href="{{ route('admin.taxi.transport_customers.index') }}" class="kt-btn kt-btn-outline">Annuleren</a>
